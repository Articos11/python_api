...
# Os argumentos do usuário, para que eles passem o email e nome.     
user_args = reqparse.RequestParser()
user_args.add_argument('name', type=str, required=True, help="Name cannot be blank")
user_args.add_argument('email', type=str, required=True, help="email cannot be blank")

# Os dados do usuário estarão aqui, num "formato" JSON.
userFields = {
    'id': fields.Integer,
    'name': fields.String,
    'email': fields.String
...
# Retornamos a lista de usuários. O ideal é retornar um JSON.
